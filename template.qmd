...
```{julia}
    ...
    scatter(
        damage,
        npv;
        xlabel="Expected Damage without elevating or sea rise (ft)",
        ylabel="NPV",
...
The most important parameter was the elevation action. On the graph, there is a very clear cone of uncertainty as the NPV rises the more you elevate, which makes sense as less money is spent on rebuilding each year.
